import { Footer as FooterWrapper, FooterGroup, FooterLink, Spacer, Text } from '@Kyo/vallista-core'
  ...
  return (
    <div>
      ...
      <Styled._FooterAllRightReserve>
        <Text size={12}>
          Copyright ⓒ {nowYear} <Link to='https://Kyojin-Hwang.github.com'>Kyojin-Hwang (Owen)</Link> All rights
          reserved.
        </Text>
        <Spacer y={0.1} />
        <Text size={12}>
